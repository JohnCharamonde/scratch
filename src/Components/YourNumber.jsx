...
function YourNumber() {
  return (
      <div style={{"display":"flex","height": "100%", "width": "25%", "zIndex":"2","fontFamily":"Apercu,Lucida Grande,sans-serif", "fontWeight":"bolder", "alignItems": "center", "justifyContent": "center"}}>
