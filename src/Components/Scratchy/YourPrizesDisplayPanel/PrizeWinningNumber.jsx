...
function PrizeWinningNumber(props) {
  ...
  return (
    <div style={{"display":"flex", "backgroundColor":"aqua", "backgroundImage": "url(" + Background + ")","height": "85%", "width": "12%", "zIndex":"102","fontFamily":"Helvetica", "fontWeight":"bolder", "alignItems": "center", "justifyContent": "center", "color":"black"}}>
